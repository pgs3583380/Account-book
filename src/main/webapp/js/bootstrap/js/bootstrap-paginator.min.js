    ...
    BootstrapPaginator.prototype = {
        init: function (element, options) {
            ...
            var containerClass = this.getValueFromOption(this.options.containerClass, this.$element),
                size = this.options.size || "normal", alignment = this.options.alignment || "left",
                pages = this.getPages(),
            ...
            var itemContainer = $("<li></li>"), itemContent = $("<a></a>"), text = "", title = "",
        ...
        return $(this).each(function (index, item) {
            var $this = $(item), data = $this.data("bootstrapPaginator"),
